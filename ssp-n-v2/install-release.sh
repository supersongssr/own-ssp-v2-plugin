...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://github.com/supersongssr/own-ssp-v2-plugin/releases/download/${NEW_VER}/v2ray-linux-${VDIS}.zip"
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/supersongssr/own-ssp-v2-plugin/releases/latest"
